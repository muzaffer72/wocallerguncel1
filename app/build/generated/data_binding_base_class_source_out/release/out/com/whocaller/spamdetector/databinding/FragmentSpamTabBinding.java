...
public final class FragmentSpamTabBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentSpamTabBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentSpamTabBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSpamTabBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_spam_tab, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSpamTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSpamTabBinding((LinearLayout) rootView, contactAvatar, contactName,
          contactPhone, demoItem, nameLay, recyclerview, spamTag);
    }
