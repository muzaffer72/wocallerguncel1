...
public final class FragmentContactBinding implements ViewBinding {
  ...
  private FragmentContactBinding(@NonNull LinearLayout rootView, @NonNull TabLayout tabLayout,
  ...
  public static FragmentContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentContactBinding((LinearLayout) rootView, tabLayout, viewPager);
    }
